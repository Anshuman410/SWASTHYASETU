  ...
  return (
    <div className="space-y-6 animate-letter">
      ...
      <Modal
        ...
        subtitle="Create digital ABHA record and patient ecosystem login credentials"
        maxWidth="2xl"
      >
        <form onSubmit={handleRegisterSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 text-xs border border-slate-200 rounded-xl font-medium focus:ring-2 focus:ring-health-500/20 focus:border-health-600 focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 text-xs border border-slate-200 rounded-xl font-semibold bg-white focus:ring-2 focus:ring-health-500/20 focus:border-health-600 focus:outline-none"
              >
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
              Village Sector / Block
            </label>
            <input
              type="text"
              value={village}
              onChange={e => setVillage(e.target.value)}
              placeholder="e.g. Rampur Sector"
              className="w-full px-4 py-3 text-xs border border-slate-200 rounded-xl font-medium focus:ring-2 focus:ring-health-500/20 focus:border-health-600 focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
            <button
              ...
              className="px-5 py-2.5 border border-slate-200 rounded-xl text-xs font-semibold text-slate-600 hover:bg-slate-50 cursor-pointer transition-colors"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-6 py-3 rounded-xl bg-health-700 hover:bg-health-800 active:bg-health-900 text-white font-bold text-xs shadow-md cursor-pointer transition-colors"
            >
              Register Patient & Generate ABHA ID
            </button>
          </div>
        </form>
      </Modal>
