...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4">
      <div
        className={`w-full ${widthClasses[maxWidth]} my-auto bg-white rounded-2xl shadow-2xl border border-slate-100 transform transition-all flex flex-col max-h-[90vh] overflow-hidden animate-letter`}
